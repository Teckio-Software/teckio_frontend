...
//   projectBackgroundColor: "rgb(0 0 0 / 25%)",
//   projectBackgroundCriticalColor: "#fac465",
//   projectBackgroundSelectedColor: "rgb(0 0 0 / 25%)",
...
const defaultColors: ColorStyles = {
  ...
  evenTaskBackgroundColor: "#ecf0f1", // Gris más marcado para tareas pares.
...
//// cuando arrastras la tarea
  ...
  return (
    ...
    >
      {
        isChecked && (columns.length > 0) && <TaskList {...tableProps} />
      }
