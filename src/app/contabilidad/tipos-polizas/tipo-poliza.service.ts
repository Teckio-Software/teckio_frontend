...
export class TipoPolizaService {
  ...
  public obtenerPaginado(selectedEmpresa: number, zCantidaElementosAMostrar: number): Observable<any>{
    let params = new HttpParams();
    params = params.append('pagina', 0);
    params = params.append('recordsPorPagina', zCantidaElementosAMostrar.toString());
    return this.httpClient.get<tipoPolizaDTO[]>(this.zvApiUrl + selectedEmpresa + '/todos', {observe: 'response', params});
  }
