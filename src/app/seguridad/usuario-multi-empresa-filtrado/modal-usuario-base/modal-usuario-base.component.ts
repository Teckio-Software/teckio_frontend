...
import { corporativo, rolesPorEmpresa, empresaConRoles } from '../../usuario-multi-empresa/tsUsuarioMultiEmpresa';
...
export class ModalUsuarioBaseComponent {
  ...
  guardarNuevo(){
    ...
    if (typeof contrasenia === 'undefined' || !contrasenia || contrasenia === ""
      || typeof nombre === 'undefined' || !nombre || nombre === ""
      || typeof confirmaContrasenia === 'undefined' || !confirmaContrasenia || confirmaContrasenia === ""
      || typeof usuario === 'undefined' || !usuario || usuario === ""
      || typeof correo === 'undefined' || !correo || correo === ""
      || typeof aPaterno === 'undefined' || !aPaterno || aPaterno === ""
      || typeof aMaterno === 'undefined' || !aMaterno || aMaterno === ""
    ) {
      Swal.fire({
        title: "Error",
    ...
    this.usuarioService.creaUsuarioBase({
