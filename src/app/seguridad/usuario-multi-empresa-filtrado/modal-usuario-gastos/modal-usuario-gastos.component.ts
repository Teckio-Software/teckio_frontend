...
import { UsuarioGastosService } from '../../Servicios/usuario-gastos.service';
...
@Component({
  selector: 'app-modal-usuario-gastos',
  templateUrl: './modal-usuario-gastos.component.html',
  styleUrls: ['./modal-usuario-gastos.component.css']
})
export class ModalUsuarioGastosComponent {
  tituloAccion: string = "";
  botonAccion: string = "";
  estatus: string = "";
  mensaje: string = "";
  ...
  constructor(
    ...
    , private usuarioEmpresaGastosService: UsuarioGastosService
  ...
  guardarEditar(){
    ...
    this.usuarioEmpresaGastosService.creaRelacionUsuarioEmpresa({
      ...
      numeroEmpleado: this.formulario.get('numeroEmpleado')?.value,
