...
import {
  ...
  rolesPorEmpresa,
  empresaConRoles,
  UsuarioCreacionMultiEmpresaDTO,
...
export class ModalUsuarioProveedorComponent {
  ...
  constructor(
    private modalActual: MatDialogRef<ModalUsuarioProveedorComponent>,
  ...
  guardarEditar() {
    ...
    this.usuarioEmpresaProveedorService
      .creaRelacionUsuarioEmpresa({
